  ...
  return (
    <section className="row top-row">
      <article className="card stat-card">
        <h3 className="card-title" data-cms-key="heading_1">Revenues</h3>
        ...
        <p className="stat-caption" data-cms-key="paragraph_1">Increase compared to last week</p>
      ...
      <article className="card stat-card">
        <h3 className="card-title" data-cms-key="heading_2">Lost deals</h3>
        <div className="stat-value-row">
          <span className="stat-value">4%</span>
        </div>
        <p className="stat-caption" data-cms-key="paragraph_2">You closed 96 out of 100 deals</p>
      ...
      <article className="card goal-card">
        <h3 className="card-title" data-cms-key="heading_3">Quarter goal</h3>
